...
extern int sepol_sidtab_insert(
	sidtab_t * s, 
	sepol_security_id_t sid, 
	context_struct_t * context);

extern context_struct_t *sepol_sidtab_search(
	sidtab_t * s, 
	sepol_security_id_t sid);

extern int sepol_sidtab_map(
	sidtab_t * s,
...
extern void sepol_sidtab_map_remove_on_error(
	sidtab_t * s,
	int (*apply) (sepol_security_id_t s,
		      context_struct_t * context,
		      void *args),
	void *args);

extern int sepol_sidtab_context_to_sid(
	sidtab_t * s,                   /* IN */
