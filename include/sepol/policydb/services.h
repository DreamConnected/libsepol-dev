 ...
 */
extern int sepol_transition_sid(
	sepol_security_id_t ssid,			/* IN */
	sepol_security_id_t tsid,			/* IN */
	sepol_security_class_t tclass,		/* IN */
 ...
 */
extern int sepol_sid_to_context(
